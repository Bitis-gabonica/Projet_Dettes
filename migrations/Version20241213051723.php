 ...
 */
final class Version20241213051723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_dette (id SERIAL NOT NULL, client_id INT NOT NULL, statut BOOLEAN DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_75C54B2119EB6921 ON demande_dette (client_id)');
        $this->addSql('CREATE TABLE demande_dette_article (demande_dette_id INT NOT NULL, article_id INT NOT NULL, PRIMARY KEY(demande_dette_id, article_id))');
        $this->addSql('CREATE INDEX IDX_75B54CE8A74D4963 ON demande_dette_article (demande_dette_id)');
        $this->addSql('CREATE INDEX IDX_75B54CE87294869C ON demande_dette_article (article_id)');
        $this->addSql('CREATE TABLE dette (id SERIAL NOT NULL, client_id INT NOT NULL, date DATE NOT NULL, montant DOUBLE PRECISION NOT NULL, montant_verser DOUBLE PRECISION NOT NULL, montant_restant DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE demande_dette_article ADD CONSTRAINT FK_75B54CE8A74D4963 FOREIGN KEY (demande_dette_id) REFERENCES demande_dette (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE demande_dette_article ADD CONSTRAINT FK_75B54CE87294869C FOREIGN KEY (article_id) REFERENCES article (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE demande_dette_article DROP CONSTRAINT FK_75B54CE8A74D4963');
        $this->addSql('ALTER TABLE demande_dette_article DROP CONSTRAINT FK_75B54CE87294869C');
        ...
        $this->addSql('DROP TABLE demande_dette_article');
